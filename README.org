...
Be sure that you have git and NPM installed on your system

#+begin_src shell
$ git clone https://github.com/Buraiyen/CSULB-TC-Website.git
$ cd CSULB-TC-Website
$ npm i
$ npm run serve
#+end_src

From there, you would be able to access the website on your local server (~localhost:8080~)
